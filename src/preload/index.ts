...
contextBridge.exposeInMainWorld('raven', {
  ...
  webSearchSaveBraveKey: (key: string) => ipcRenderer.invoke('web-search:save-brave-key', key),
  webSearchTest: (backend: 'brave' | 'searxng', searxngBaseUrl?: string) => ipcRenderer.invoke('web-search:test', backend, searxngBaseUrl),
  localSearchSetup: () => ipcRenderer.invoke('local-search:setup'),
  localSearchStart: (baseUrl?: string) => ipcRenderer.invoke('local-search:start', baseUrl),
  localSearchStop: () => ipcRenderer.invoke('local-search:stop'),
