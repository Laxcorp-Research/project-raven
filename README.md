...
| Platform | Installer |
|----------|-----------|
| **Windows 10/11 (x64)** | [Raven-Windows-2.4.1-Setup.exe](https://github.com/Laxcorp-Research/project-raven/releases/download/v2.4.1/Raven-Windows-2.4.1-Setup.exe) |
| **macOS 12+ (Apple Silicon)** | [Raven-Mac-2.4.1-Installer.dmg](https://github.com/Laxcorp-Research/project-raven/releases/download/v2.4.1/Raven-Mac-2.4.1-Installer.dmg) |
