...
| Platform | Installer |
|----------|-----------|
| **Windows 10/11 (x64)** | [Raven-Windows-2.3.12-Setup.exe](https://github.com/Laxcorp-Research/project-raven/releases/download/v2.3.12/Raven-Windows-2.3.12-Setup.exe) |
